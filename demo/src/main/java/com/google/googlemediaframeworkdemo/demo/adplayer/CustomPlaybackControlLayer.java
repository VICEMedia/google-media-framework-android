...
/**
 * Created by oliverbudiardjo on 12/29/15.
 */
...
import com.google.googlemediaframeworkdemo.demo.R;
 ...
 *
 * <p>The view appears when the container containing the {@link CustomPlaybackControlLayer} is tapped. It
...
public class CustomPlaybackControlLayer extends PlaybackControlLayer implements Layer, PlayerControlCallback {
     ...
     * buttons.
     *
     * <p> 3) The translucent middle section of the CustomPlaybackControlLayer.
     *
     ...
     */
    private Handler handler = new PlaybackControlLayer.MessageHandler(this);
    ...
    /**
     * The drawable that will be displayed in the {@link CustomPlaybackControlLayer#logoImageView}.
     */
    ...
    /**
     * The title displayed in the {@link CustomPlaybackControlLayer#videoTitleView}.
     */
    ...
    /**
     * The view created by this {@link CustomPlaybackControlLayer}
     */
    private FrameLayout view;

    public CustomPlaybackControlLayer(String videoTitle) {
        this(videoTitle, null);
    }

    public CustomPlaybackControlLayer(String videoTitle, FullscreenCallback fullscreenCallback) {
    ...
    public FrameLayout createView(LayerManager layerManager) {
        ...
        view = (FrameLayout) inflater.inflate(R.layout.custom_playback_control_layer, null);
        setupView();
